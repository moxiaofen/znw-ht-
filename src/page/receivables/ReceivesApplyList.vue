<template>
  <div class="bg">
    <ToolBar page_title="应收账款转让申请"  :isWhile="false"></ToolBar>
                ...
                <div class="item">
                  <div class="item-left">
                    <div class=" item-line1 tal">
                      <div>
                        <p class="contract-name">全保理产品</p>
                        <p class="contract-no">{{item.creditContractNo}}LA2019080100002</p>
                      </div>
                    </div>

                    <div class="item-line2">
                      <span class="contract-amount">{{item.transferAmt}}200000.0元</span>
                    </div>
                  ...
                  <div class="item-right">
                      <img class=" img-type" src="static/assets/icon_progress_sucess.png"></span>
                  </div>
                </div>
              </li>
            </ul>
