 ...
 <ToolBar page_title="忘记密码" :isWhile="true" imgUrl="static/assets/icon_black_back.png"> </ToolBar>
    ...
    <div class="content">
      ...
      <div class='top'>
        ...
        <img class='clearCss' v-show="vSetPwd1" @click="clearPwd(vSetPwd1)" src="static/assets/clear.png"/>
      ...
      <div class='top'>
        ...
        <img class='clearCss' v-show="vSetPwd2" @click="clearPwd(vSetPwd2)" src="static/assets/clear.png"/>
