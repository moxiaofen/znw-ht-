<template>
  <div>
    <ToolBar page_title="企业信息" :isWhile="false"> </ToolBar>
    ...
    <div class="content">      
      ...
      <div>
          ...
          <div class='top'>
            <span class='inputLable'>营业执照注册号</span>
            <input class='inputVal' type="text" ref="rIdNo" v-model="vIdNo" placeholder="请输入营业执照注册号" />
          </div>
          <!--横线-->
          <Divider></Divider>

          <div class='top'>
            <span class='inputLable'>组织机构代码</span>
            <input class='inputVal' type="text" ref="rCustName" v-model="vCustName" placeholder="请输入组织机构代码" />
          </div>
          <!--横线-->
          <Divider></Divider>
      </div>
      <!--身份资料-->
      <p class="cont-item">身份资料</p>
      <div>
          <div class='top'>
            <span class='inputLable'>请选择您的身份</span>
          ...
          <div class='top'>
            <span class='inputLable'>企业法人身份证</span>
            <input class='inputVal' type="text" ref="rContact" v-model="VContact" placeholder="请输入企业法人身份证" />
          </div>
          <!--横线-->
          <Divider></Divider>
      </div>
